...
public class CyclomaticServer {
   ...
   /* 	FileRepositoryBuilder builder = new FileRepositoryBuilder();
	...
	public String listCommits() throws MissingObjectException, IncorrectObjectTypeException, CorruptObjectException, IOException, GitAPIException {
	...
	/*public String test() throws IOException, GitAPIException
    {
    	
		getRepo();
    	String commitList = listCommits();
    	System.out.println("Commit found:");
    	for (String commit : commitList) 
    	{
    	    System.out.println(commit);    	
    	}
		return "<Commit>" + commitList +"</Commit>";
